...
module DeviseTokenAuth
  class RegistrationsController < DeviseTokenAuth::ApplicationController
    ...
    def create
      ...
      callback_name = defined?(ActiveRecord) && user_resource_class < ActiveRecord::Base ? :commit : :create
      user_resource_class.set_callback(callback_name, :after, :send_on_create_confirmation_instructions)
      user_resource_class.skip_callback(callback_name, :after, :send_on_create_confirmation_instructions)
